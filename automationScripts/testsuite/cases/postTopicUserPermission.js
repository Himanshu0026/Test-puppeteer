...
postTopicUserPermissionTestcases.verifyClickOnAnyTopicDisable = function(userGroup) {
	casper.thenOpen(config.url, function() {
		...
		postTopicUserPermissionTestcases.getTokenAndSetPermission(config.apiLocalUrl+"/restapi/usergroups/updatePermission/"+userGroup+"/view_thread_content/0?accesToken=");
...
postTopicUserPermissionTestcases.verifyClickOnAnyTopicEnable = function(userGroup) {
	casper.then(function() {
		postTopicUserPermissionTestcases.getTokenAndSetPermission(config.apiLocalUrl+"/restapi/usergroups/updatePermission/"+userGroup+"/view_thread_content/1?accesToken=");
	}).thenOpen(config.url, function() {
