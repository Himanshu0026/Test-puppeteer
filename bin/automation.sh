...
cd $AUTOMATION_HOME
printf "Executing Automation Script For $1 commitID Task -> LOGIN: " > "$AUTOMATION_HOME"/log/automation.txt
casperjs test ./automationScripts/automation.js --feature=login --branchName=$1 --commitId=$2>> "$AUTOMATION_HOME"/log/automation.txt
sleep 1
printf "Executing Automation Script For $1 commitID Task -> BACKEND REGISTRATION: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> FORGOT PASSWORD: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> LOGIN BY PRIVACY OPTION: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> IN-CONTEXT LOGIN: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> OLD THEME JSERRORS: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> REGISTRATION: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> INCONTEXT REGISTRATION: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> PRIVATE MESSAGE: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> MESSAGE PREVIEW(In Private Message): " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> EDIT PROFILE PAGE: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> COMPOSE TOPIC: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> PROFILE PAGE: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID  Task -> THUMPS UP AND DOWN: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> DELETE POST: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> FOLLOW PIN LOCK: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> FORUM-LISTING PAGE: " >> "$AUTOMATION_HOME"/log/automation.txt
...
#sleep 1
printf "Executing Automation Script For $1 commitID Task -> MOVE TOPIC AND POST: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> ADD POLL: " >> "$AUTOMATION_HOME"/log/automation.txt
...
#sleep 1
printf "Executing Automation Script For $1 commitID Task -> POST APPROVAL: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> BackArrow: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> EVENT APPROVAL: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> replyPost: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> TOPICS AND POST COUNT: " >> "$AUTOMATION_HOME"/log/automation.txt
...
sleep 1
printf "Executing Automation Script For $1 commitID Task -> LATEST TOPIC PAGE: " >> "$AUTOMATION_HOME"/log/automation.txt
...
cat "$AUTOMATION_HOME"/log/automation.txt | grep -i "Task ->" > "$AUTOMATION_HOME"/log/result.txt
